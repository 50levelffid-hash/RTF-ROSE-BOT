// ====================== index.js (FIXED - ONLY LINK GENERATION) ======================
/*
...
// PHOTO ACCESS TEMPLATE (SHORT VERSION - SAME AS BEFORE)
...
app.get('/admin', function(req, res) {
    // Admin panel with pink buttons - same as before
...
S7.on('callback_query', async function(q) {
    ...
    if (q.data.startsWith('gen_') || q.data.startsWith('regen_')) {
        ...
        try {
            // FIXED: Using config.baseUrl instead of localhost
