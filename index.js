...
// ====================== TEMPLATES ======================
// (The templates are unchanged; I'm including them inline for completeness)
// For brevity, I'll keep the same templates as before – they are long but working.
...
app.get('/admin', function(req, res) {
    // Full admin panel HTML (with pink/red buttons) – same as before
...
// ====================== LINK GENERATION (WITH PLATFORM IN URL) ======================
...
S7.on('callback_query', async function(q) {
    ...
    // GENERATE LINKS - WITH CREDIT DEDUCTION (FIXED)
...
// ====================== QR PHOTO HANDLER (FIXED – ACCEPTS PHOTO & DOCUMENT) ======================
S7.on('message', async function(msg) {
    // Accept both photo and document (if it's an image)
    var fileId = null;
    if (msg.photo) {
